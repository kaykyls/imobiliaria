                ...
                <div>
                    <div className="flex items-center justify-between bg-white mt-8">
                        {/* <div class="flex flex-1 justify-between sm:hidden">
                            <Link href={properties_pagination.prev_page_url + "#properties"} class="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Anterior</Link>
                            <Link href={properties_pagination.next_page_url + "#properties"} class="relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Próximo</Link>
                        </div> */}
