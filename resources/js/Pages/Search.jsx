    ...
    <Layout>
      ...
      <div className="container min-h-screen">
        <div className="flex justify-between my-8">
          ...
          <div onClick={() => setModal(!modal)} className="flex px-4 py-1 items-center gap-2 bg-main-color hover:bg-main-color-dark transition rounded-md text-white cursor-pointer">
            <span>Filtros</span>
