                ...
                <div className="space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button
                            disabled={processing}
                            type="submit"
                            className="rounded-md bg-main-color px-3 py-2 text-base font-semibold text-white shadow-sm hover:bg-main-color-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-main-color"
                            onClick={submit}
                        >
                        Registrar
                        </button>
