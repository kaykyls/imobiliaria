        ...
        <div className='container flex flex-col xl:flex-row'>
            ...
            <div id="#contact" className="md:flex xl:mx-10 gap-20 my-10 md:my-20">
              <div>
                  ...
                  <button className="flex justify-center items-center gap-2 mb-4 w-full border-gray-300  bg-main-color hover:bg-main-color-dark text-white font-semibold color-white py-2 transition duration-500 cursor-pointer"  >
