  ...
  return (
    <Layout>
        <div className='container flex flex-col xl:flex-row'>
            <div className='w-full'>
              ...
              <div className="mt-4">
                <ul className="space-y-2 mb-4">
                  <li><span className="text-gray-600">{address.street}, {address.number}.</span></li>
                  <li><span className="text-gray-600">{address.district}, {address.cep}.</span></li>
                  {address.complement && <li><span className="text-gray-600">{address.complement}</span></li>}
                </ul>
              </div>
              <h2 className='text-xl py-4 font-bold tracking-tight text-gray-900 sm:text-xl border-t border-gray-200'>Detalhes</h2>
                <div className="flex gap-5 mt-4">
                  <div className="flex gap-2 flex-wrap">
                    <div className="flex gap-2 items-center hover:bg-gray-100 transition border rounded-full px-4 py-1">
            ...
            <div id="#contact" className="md:flex xl:mx-10 gap-20 my-10 md:my-20">
              <div>
                  
                  <button className="flex justify-center items-center gap-2 mb-4 w-full border-gray-300  bg-main-color hover:bg-main-color-dark text-white font-semibold color-white py-2 transition duration-500 cursor-pointer rounded-md">
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col md:w-[400px] ">
                      ...
                      <input className="border-gray-300 bg-gray-300 hover:bg-gray-400 transition font-semibold shadow-sm py-2 duration-500 cursor-pointer w-full rounded-md" type="submit" value="Enviar"/>
                  </form>
              </div>
