                ...
                <div className="container mx-auto flex justify-between items-end">
                    ...
                    <form className='hidden md:block' onSubmit={handleSubmit}>
                        <div className='relative'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 absolute h-full left-3 pointer-events-none text-gray-400">
                                <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                            </svg>
                            <input id="search" name="search" placeholder="Pesquisar..." className="pl-10 w-[300px] lg:w-[700px] h-8 rounded-md border-0 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-main-color" type="text" />
                        </div>
                    </form>
                    <div className="hidden md:flex">
                        <div className='flex items-end gap-6'>
                            <a target='_blank' href='https://www.instagram.com'>
                                <svg width="20" height="19.33" viewBox="0 0 30 29" fill="none" xmlns="https://www.w3.org/2000/svg">
                            ...
                            <a target='_blank' href='https://www.facebook.com'>
                                <svg width="20" height="20" viewBox="0 0 30 30" fill="none" xmlns="https://www.w3.org/2000/svg">
                ...
                <ul ref={menuRef} className={`${showMenu ? "flex flex-col absolute top-0 right-0 shadow-2xl bg-white h-screen w-[300px] items-center justify-center -translate-x-0" : "md:flex sr-only md:not-sr-only absolute md:static -translate-x-[-100%] md:-translate-x-0"} transition-transform duration-300 md:duration-0 ease-in-out gap-4 z-50`}>
                    ...
                    <form className='block md:hidden' onSubmit={handleSubmit}>
                        <div className='relative'>
                            ...
                            <input id='search-mobile' name='search-mobile' placeholder="Pesquisar..." className="pl-10 w-full h-8 rounded-md border-0 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-main-color" type="text" />
                        </div>
                    </form>
                </nav>
            </div>     
