...
const Header = () => {
    ...
    return (
        <header className='sticky top-0 left-0 bg-white w-full z-50 shadow-lg'>
                    ...
                    <div className="hidden md:flex">
                        <div className='flex items-end gap-4'>
                            ...
                            <a target='_blank' href='https://www.instagram.com'>
                                <svg width="24" height="23.2" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
